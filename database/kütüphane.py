...
class Kütüphane():
    ...
    def kitap_sorgula2(self,yazar):
        ...
        if (len(kitaplar) == 0):
            ...
            return kitap
    def kitap_sorgula3(self,yayınevi):
    ...
    def findName(self,bilgi):
        if( self.kitap_sorgula(bilgi) ):
            sorgu = "Select * From kitaplar where isim = ?"

            self.cursor.execute(sorgu, (bilgi,))
        ...
        elif( self.kitap_sorgula2(bilgi) ):
            sorgu = "Select * From kitaplar where yazar = ?"
        ...
        elif( self.kitap_sorgula3(bilgi) ):
            sorgu = "Select * From kitaplar where yayınevi = ?"
